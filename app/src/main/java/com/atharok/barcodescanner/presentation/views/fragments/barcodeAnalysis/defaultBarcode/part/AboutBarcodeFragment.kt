...
import com.atharok.barcodescanner.databinding.FragmentAboutBarcodeBinding
 ...
 */
class AboutBarcodeFragment : ProductBarcodeFragment<BarcodeProduct>() {

    private var _binding: FragmentAboutBarcodeBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentAboutBarcodeBinding.inflate(inflater, container, false)
    ...
    private fun configureAboutBarcodeTemplates(inflater: LayoutInflater) {
        ...
        val expandableViewTemplate = viewBinding.fragmentAboutBarcodeExpandableViewTemplate
    ...
    private fun configureFormat(barcodeProduct: BarcodeProduct){
        val formatName = barcodeProduct.barcode.formatName.replace("_", " ")
    ...
    private fun configureOrigin(barcodeProduct: BarcodeProduct){
        val origin = barcodeProduct.barcode.country
    ...
    private fun configureDescription(barcodeProduct: BarcodeProduct){
        val text = when(barcodeProduct.barcode.getBarcodeFormat()){
