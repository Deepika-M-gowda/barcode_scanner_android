 ...
 * Use the [FoodProductNutrientLevelFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FoodProductNutrientLevelFragment : Fragment() {

    private var nutrient: Nutrient? = null

    private var _binding: FragmentFoodProductNutrientLevelBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentFoodProductNutrientLevelBinding.inflate(inflater, container, false)
    ...
    private fun configureNutrientLevelTemplates(inflater: LayoutInflater) {
        ...
        val expandableViewTemplate = viewBinding.fragmentNutrientLevelExpandableViewTemplate
