...
enum class LibraryThird(val nameResource: Int, val licenseResource: Int, val authorResource: Int, val descriptionResource: Int, val webLinkResource: Int) {
    ...
    ZXING_ANDROID_EMBEDDED(R.string.dependency_zxing_android_embedded_title_label, R.string.dependency_zxing_android_embedded_license_label, R.string.dependency_zxing_android_embedded_author_label, R.string.dependency_zxing_android_embedded_description_label, R.string.dependency_zxing_android_embedded_github_link_label),
