...
import com.atharok.barcodescanner.databinding.FragmentBarcodeErrorApiBinding
 ...
 */
class BarcodeErrorApiFragment: ProductBarcodeFragment<BarcodeProduct>() {

    private var _binding: FragmentBarcodeErrorApiBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentBarcodeErrorApiBinding.inflate(inflater, container, false)
    ...
    private fun configureWarningTemplates(inflater: LayoutInflater) {
        ...
        val expandableViewTemplate = viewBinding.warningExpandableViewTemplate
