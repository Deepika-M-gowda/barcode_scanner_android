 ...
 */
class FoodProductQualityFragment : BaseFragment() {
    ...
    private var _binding: FragmentFoodProductQualityBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentFoodProductQualityBinding.inflate(inflater, container, false)
    ...
    private fun configureProductQualityTemplates(inflater: LayoutInflater) {
        ...
        val expandableViewTemplate = viewBinding.fragmentFoodProductQualityExpandableViewTemplate
