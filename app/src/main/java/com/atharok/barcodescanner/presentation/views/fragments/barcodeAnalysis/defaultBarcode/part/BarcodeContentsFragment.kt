...
import com.atharok.barcodescanner.databinding.FragmentBarcodeContentsBinding
 ...
 */
class BarcodeContentsFragment: ProductBarcodeFragment<BarcodeProduct>() {
    ...
    private var _binding: FragmentBarcodeContentsBinding? = null
    private val viewBinding get() = _binding!!

    private lateinit var headerEntitledTemplateBinding: TemplateEntitledViewBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentBarcodeContentsBinding.inflate(inflater, container, false)
    ...
    private fun configureBarcodeContentsTemplates(inflater: LayoutInflater) {
        ...
        val expandableViewTemplate = viewBinding.fragmentBarcodeContentsExpandableViewTemplate
    ...
    override fun start(product: BarcodeProduct) {
        ...
        displayResult = parsedResult.displayResult
    ...
    private fun configureBarcodeContentsFragment(parsedResult: ParsedResult, displayResult: String?){
        ...
        val frameLayout = viewBinding.fragmentBarcodeContentsExpandableViewTemplate.templateExpandableViewBodyFrameLayout
