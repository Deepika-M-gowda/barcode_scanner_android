...
import com.atharok.barcodescanner.databinding.FragmentFoodProductLabelsBinding
 ...
 */
class FoodProductLabelsFragment : ProductBarcodeFragment<FoodProduct>() {
    ...
    private var _binding: FragmentFoodProductLabelsBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentFoodProductLabelsBinding.inflate(inflater, container, false)
    ...
    private fun configureLabelsTemplates(inflater: LayoutInflater) {
        ...
        val expandableViewTemplate = viewBinding.productLabelsExpandableViewTemplate
