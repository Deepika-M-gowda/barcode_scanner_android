 ...
 */
class FoodProductAdditivesFragment: ProductBarcodeFragment<FoodProduct>() {

    private val viewModel: ExternalFileViewModel by sharedViewModel()
    private var additivesAdapter: AdditivesItemAdapter? = null

    private var _binding: FragmentFoodProductAdditivesBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding=FragmentFoodProductAdditivesBinding.inflate(inflater, container, false)
